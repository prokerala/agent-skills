# GET /astrology/anandadi-yoga

**Resource:** [Daily Panchang](../resources/Daily-Panchang.md)
**Summary:** Anandadi Yoga
**Operation ID:** `get-anandadi-yoga`
...
| `la` | query | string | No | Enum `en`, `ta`. <br>Choose language |
...
[AnandadiYogaResponse](../schemas/Anandadi/AnandadiYogaResponse.md)
