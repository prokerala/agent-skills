# GET /astrology/progression-planet-position

**Resource:** [Western Astrology](../resources/Western-Astrology.md)
**Summary:** Progression Planet Position
**Operation ID:** `get-progression-planet-position`
...
| `progression_year` | query | string | Yes | Enter the years in int (eg: 2022) |
...
[ProgressionPlanetPositionResponse](../schemas/Progression/ProgressionPlanetPositionResponse.md)
