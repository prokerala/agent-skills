# GET /astrology/transit-planet-position

**Resource:** [Western Astrology](../resources/Western-Astrology.md)
**Summary:** Transit Planet Position
**Operation ID:** `get-transit-planet-position`
...
| `transit_datetime` | query | string | Yes | ISO 8601 date-time with the correct timezone offset; see [common-pitfalls.md](../common-pitfalls.md). |
| `current_coordinates` | query | string | Yes | Location is accepted in the form of latitude and longitude eg: `10.214747,78.097626`. |
...
**Response Content Types:** `application/json`, `application/xml`, `multipart/form-data`

**Success Response Schema:**

[TransitPlanetPositionResponse](../schemas/Transit/TransitPlanetPositionResponse.md)
